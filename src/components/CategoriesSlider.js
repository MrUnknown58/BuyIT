  ...
  return (
    ...
    <Link to={`showcategorywiseproduct/${props.element.category}`}>
        <div className="hover:cursor-pointer rounded-3xl underline-offset-2 hover:underline pb-10 flex-col shadow-lg shadow-cyan-700 z-10">
          <img alt="team" className="flex-shrink-0 rounded-lg w-[450px] h-[227px] object-cover object-center mb-4" src={props.element.url}/>
          <div className="w-full">
            <h2 className="title-font font-medium text-lg text-gray-900">{props.element.name}</h2>
            <h3 className="text-gray-500 mb-3">{props.element.type}</h3>
            <p className="mb-4">{props.element.shortdesc}</p>
